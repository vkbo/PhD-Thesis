...
\begin{table}[hbt]
    \centering
    \caption{Accelerators world wide with proton beams with an energy higher thant $10\unit{GeV}$. The table was compiled by Adli and Muggli~\cite{adli:2016b}, and updated to include the planned upgrade to the LHC.}
    \label{T:ProtonBeams}
    \begin{tabularx}{\textwidth}{X d{1} d{1} d{1} d{1}}
        ...
        CERN LHC, Geneva, Switzerland \cite{assmann:2009}
            & 7000 & 124    &  0.25 &   75 \\
        CERN HL-LHC, Geneva, Switzerland \cite{apollinari:2017}
            & 7000 & 247    &  0.27 &   81 \\
        \hline
    \end{tabularx}
\end{table}
