...
The fourth and fifth chapters outline the simulations, which makes up most of the thesis work.
...
\begin{figure}[hbt]
    ...
    \caption{\label{Fig:BPI:Density}
        \textbf{Top:} Relative on-axis plasma density perturbation for an $n_{b}/n_{pe}$ density ratio corresponding to a linear, quasi-linear, non-linear and highly non-linear case.
...
Efficiency is instead increased when each bunch experiences a similar wakefield.
