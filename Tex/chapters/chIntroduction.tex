...
\begin{table}[hbt]
    ...
    \begin{tabularx}{\textwidth}{X d{1} d{1} d{1} d{1}}
        \rowcolor{tblhead}
        \texthh{Accelerator}
            & \multicolumn{2}{c}{\texthh{Max Energy}} & \multicolumn{2}{c}{\texthh{Bunch Length}} \\
        \rowcolor{tblunit}
