...
\begin{figure}[hbt]
    ...
    \caption{\label{Fig:SimA:EMFNoise}
        ...
        The data is taken at the entry into the plasma region, and shows results for both the Yee solver and the slighlty better 4\ts{th} order solver in OSIRIS 3.0.
...
However, due to the numerical noise in the electromagnetic field solver associated with full PIC codes, as also discussed in the appendix, we moved to QuicPIC at this stage,
...
\begin{figure}[hbt]
    ...
    \caption{\label{Fig:SimA:BL17Emitt}
        Emiitance of an electron bunch along the $\xi$ axis.
...
In Publication~\ref{Pub:BL17}, we performed a number of parameter scans, attemting to maximise beam quality as defined in Equation~\ref{EQ:BeamQ}.
