...
\end{align}
while the particles are advanced in time using the Newton-Lorentx equations
\begin{align}
...
\begin{figure}[hbt]
    ...
    \caption{\label{Fig:PIC} The four main steps of the PIC algorithm.
...
\begin{description}
    ...
    This, however, comes woth a performance penalty.
...
\begin{figure}[hbt]
    ...
    \caption{\label{Fig:PIC:EMF}
        \textbf{Left:} On the staggered Yee grid, current densities and electric fields are defined on the edges of the cells, and magnetic fields on the faces.
        \textbf{Right:} Leapfrog time integration using alternating half time steps for electric and magnetic fields.
        Figure recreated from Vay \etal~\cite{vay:2016}.
    }
\end{figure}
