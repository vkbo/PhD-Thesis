...
for n=1:nN
    for s=1:nS
        ...
        hold on;
        for p=1:n
            plot(aAxis(:,p), (aQEmt(:,p)./aQTot(:,p))*100,'LineStyle','-','LineWidth',1.5,'Marker',sMark{p},'MarkerFaceColor',cCol(1,:));
        end % for
        hold off;
        ...
        hold on;
        for p=1:n
            plot(aAxis(:,p), (aRMom(:,p)./aMMom(:,p))*100,'LineStyle','-','LineWidth',1.5,'Marker',sMark{p},'MarkerFaceColor',cCol(2,:));
        end % for
        hold off;
